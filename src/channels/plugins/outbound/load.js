...
exports.loadChannelOutboundAdapter = loadChannelOutboundAdapter;
...
function loadChannelOutboundAdapter(id) {
  return __awaiter(this, void 0, void 0, function () {
    var registry, cached, pluginEntry, outbound;
    return __generator(this, function (_a) {
      registry = (0, runtime_js_1.getActivePluginRegistry)();
      ...
      outbound =
        pluginEntry === null || pluginEntry === void 0 ? void 0 : pluginEntry.plugin.outbound;
      if (outbound) {
        cache.set(id, outbound);
        return [2 /*return*/, outbound];
      }
