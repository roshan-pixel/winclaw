...
exports.normalizeSlackWebhookPath = normalizeSlackWebhookPath;
exports.registerSlackHttpHandler = registerSlackHttpHandler;
exports.handleSlackHttpRequest = handleSlackHttpRequest;
var slackHttpRoutes = new Map();
...
function registerSlackHttpHandler(params) {
  var _a;
  var normalizedPath = normalizeSlackWebhookPath(params.path);
  if (slackHttpRoutes.has(normalizedPath)) {
    var suffix = params.accountId ? ' for account "'.concat(params.accountId, '"') : "";
    (_a = params.log) === null || _a === void 0
      ? void 0
      : _a.call(
          params,
          "slack: webhook path ".concat(normalizedPath, " already registered").concat(suffix),
        );
    return function () {};
  }
...
function handleSlackHttpRequest(req, res) {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          handler = slackHttpRoutes.get(url.pathname);
          if (!handler) {
