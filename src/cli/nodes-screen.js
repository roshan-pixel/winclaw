...
exports.parseScreenRecordPayload = parseScreenRecordPayload;
exports.screenRecordTempPath = screenRecordTempPath;
exports.writeScreenRecordToFile = writeScreenRecordToFile;
...
function screenRecordTempPath(opts) {
  ...
  return path.join(tmpDir, "openclaw-screen-record-".concat(id).concat(ext));
}
function writeScreenRecordToFile(filePath, base64) {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      return [2 /*return*/, (0, nodes_camera_js_1.writeBase64ToFile)(filePath, base64)];
    });
  });
}
