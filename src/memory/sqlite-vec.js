...
function loadSqliteVecExtension(params) {
  return __awaiter(this, void 0, void 0, function () {
    var sqliteVec, resolvedPath, extensionPath, err_1, message;
    var _a;
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          sqliteVec = _b.sent();
          resolvedPath = (
            (_a = params.extensionPath) === null || _a === void 0 ? void 0 : _a.trim()
          )
            ? params.extensionPath.trim()
            : undefined;
          extensionPath =
            resolvedPath !== null && resolvedPath !== void 0
              ? resolvedPath
          ...
          return [2 /*return*/, { ok: true, extensionPath: extensionPath }];
        case 2:
          err_1 = _b.sent();
