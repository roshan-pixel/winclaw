...
exports.refreshQwenPortalCredentials = refreshQwenPortalCredentials;
...
function refreshQwenPortalCredentials(credentials) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          if (!((_a = credentials.refresh) === null || _a === void 0 ? void 0 : _a.trim())) {
        ...
        case 2:
          ...
          if (response.status === 400) {
            throw new Error(
              "Qwen OAuth refresh token expired or invalid. Re-authenticate with `".concat(
          ...
          throw new Error("Qwen OAuth refresh failed: ".concat(text || response.statusText));
        case 3:
