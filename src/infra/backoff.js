...
function computeBackoff(policy, attempt) {
  var base = policy.initialMs * Math.pow(policy.factor, Math.max(attempt - 1, 0));
  var jitter = base * policy.jitter * Math.random();
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          _a.trys.push([1, 3, , 4]);
          return [4 /*yield*/, (0, promises_1.setTimeout)(ms, undefined, { signal: abortSignal })];
        case 2:
          _a.sent();
          return [3 /*break*/, 4];
        case 3:
