...
exports.withTimeout =
  exports.clampPercent =
  exports.ignoredErrors =
  exports.usageProviders =
  exports.PROVIDER_LABELS =
  exports.DEFAULT_TIMEOUT_MS =
    void 0;
exports.resolveUsageProviderId = resolveUsageProviderId;
...
function resolveUsageProviderId(provider) {
  ...
  return exports.usageProviders.includes(normalized) ? normalized : undefined;
}
exports.ignoredErrors = new Set([
  "No credentials",
  "No token",
  "No API key",
  "Not logged in",
...
var withTimeout = function (work, ms, fallback) {
