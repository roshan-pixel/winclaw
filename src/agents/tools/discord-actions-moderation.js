...
exports.handleDiscordModerationAction = handleDiscordModerationAction;
var send_js_1 = require("../../discord/send.js");
var common_js_1 = require("./common.js");
function handleDiscordModerationAction(action, params, isActionEnabled) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 1:
          ...
          durationMinutes =
            typeof params.durationMinutes === "number" && Number.isFinite(params.durationMinutes)
              ...
              : undefined;
          until = (0, common_js_1.readStringParam)(params, "until");
          reason = (0, common_js_1.readStringParam)(params, "reason");
          if (!accountId) {
            return [3 /*break*/, 3];
          }
          return [
            4 /*yield*/,
            (0, send_js_1.timeoutMemberDiscord)(
              {
                guildId: guildId,
                userId: userId,
        ...
        case 5:
          member = _b;
          return [2 /*return*/, (0, common_js_1.jsonResult)({ ok: true, member: member })];
        case 6:
          if (!isActionEnabled("moderation", false)) {
            throw new Error("Discord moderation is disabled.");
          }
          ...
          return [
            4 /*yield*/,
            (0, send_js_1.kickMemberDiscord)(
              { guildId: guildId, userId: userId, reason: reason },
              { accountId: accountId },
            ),
          ];
        case 7:
        ...
        case 8:
          return [
            4 /*yield*/,
            (0, send_js_1.kickMemberDiscord)({ guildId: guildId, userId: userId, reason: reason }),
          ];
        case 9:
          _c.sent();
          _c.label = 10;
