...
function readLatestAssistantReply(params) {
  return __awaiter(this, void 0, void 0, function () {
    var history, filtered, last;
    var _a;
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          ...
          return [
            2 /*return*/,
            last ? (0, sessions_helpers_js_1.extractAssistantText)(last) : undefined,
          ];
      }
    });
  });
}
function runAgentStep(params) {
  return __awaiter(this, void 0, void 0, function () {
    var stepIdem, response, stepRunId, resolvedRunId, stepWaitMs, wait;
    var _a, _b;
    return __generator(this, function (_c) {
      switch (_c.label) {
        case 0:
          stepIdem = node_crypto_1.default.randomUUID();
          return [
            4 /*yield*/,
            (0, call_js_1.callGateway)({
              method: "agent",
              params: {
                ...
                deliver: false,
                channel:
                  (_a = params.channel) !== null && _a !== void 0
                    ? _a
                    : message_channel_js_1.INTERNAL_MESSAGE_CHANNEL,
                lane:
                  (_b = params.lane) !== null && _b !== void 0 ? _b : lanes_js_1.AGENT_LANE_NESTED,
        ...
        case 1:
          ...
          stepRunId =
            typeof (response === null || response === void 0 ? void 0 : response.runId) ===
              ...
              ? response.runId
              : "";
          resolvedRunId = stepRunId || stepIdem;
          stepWaitMs = Math.min(params.timeoutMs, 60000);
          return [
            4 /*yield*/,
            (0, call_js_1.callGateway)({
              method: "agent.wait",
        ...
        case 2:
          ...
          return [4 /*yield*/, readLatestAssistantReply({ sessionKey: params.sessionKey })];
        case 3:
