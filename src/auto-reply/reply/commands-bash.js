...
var handleBashCommand = function (params, allowTextCommands) {
  return __awaiter(void 0, void 0, void 0, function () {
    var command, bashSlashRequested, bashBangRequested, reply;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          bashBangRequested = command.commandBodyNormalized.startsWith("!");
          if (!bashSlashRequested && !(bashBangRequested && command.isAuthorizedSender)) {
            return [2 /*return*/, null];
          }
          if (!command.isAuthorizedSender) {
            (0, globals_js_1.logVerbose)(
              "Ignoring /bash from unauthorized sender: ".concat(command.senderId || "<unknown>"),
            );
            return [2 /*return*/, { shouldContinue: false }];
          }
          return [
            4 /*yield*/,
            (0, bash_command_js_1.handleBashChatCommand)({
              ctx: params.ctx,
              cfg: params.cfg,
