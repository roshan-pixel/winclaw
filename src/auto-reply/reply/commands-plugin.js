...
exports.handlePluginCommand = void 0;
 ...
 */
var handlePluginCommand = function (params, allowTextCommands) {
  return __awaiter(void 0, void 0, void 0, function () {
    var command, cfg, match, result;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          match = (0, commands_js_1.matchPluginCommand)(command.commandBodyNormalized);
          if (!match) {
            return [2 /*return*/, null];
          }
          return [
