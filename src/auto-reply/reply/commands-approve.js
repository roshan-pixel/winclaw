...
exports.handleApproveCommand = void 0;
...
function buildResolvedByLabel(params) {
  var _a;
  var channel = params.command.channel;
  var sender = (_a = params.command.senderId) !== null && _a !== void 0 ? _a : "unknown";
  return "".concat(channel, ":").concat(sender);
}
var handleApproveCommand = function (params, allowTextCommands) {
  return __awaiter(void 0, void 0, void 0, function () {
    var normalized, parsed, resolvedBy, err_1;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          parsed = parseApproveCommand(normalized);
          if (!parsed) {
            return [2 /*return*/, null];
          }
          if (!params.command.isAuthorizedSender) {
            (0, globals_js_1.logVerbose)(
              "Ignoring /approve from unauthorized sender: ".concat(
          ...
          if (!parsed.ok) {
            return [2 /*return*/, { shouldContinue: false, reply: { text: parsed.error } }];
          }
          resolvedBy = buildResolvedByLabel(params);
          _a.label = 1;
        case 1:
          _a.trys.push([1, 3, , 4]);
          return [
            ...
            (0, call_js_1.callGateway)({
              ...
              clientDisplayName: "Chat approval (".concat(resolvedBy, ")"),
        ...
        case 3:
          ...
          return [
            2 /*return*/,
            {
              ...
              reply: {
                text: "\u274C Failed to submit approval: ".concat(String(err_1)),
              },
            },
          ];
        case 4:
          return [
            2 /*return*/,
            {
              ...
              reply: {
                text: "\u2705 Exec approval "
                  .concat(parsed.decision, " submitted for ")
                  .concat(parsed.id, "."),
              },
            },
          ];
