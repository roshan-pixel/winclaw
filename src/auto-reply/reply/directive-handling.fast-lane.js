...
function applyInlineDirectivesFastLane(params) {
    ...
    return __generator(this, function (_g) {
      switch (_g.label) {
        case 0:
          ...
          if (
            !commandAuthorized ||
            (0, directive_handling_parse_js_1.isDirectiveOnly)({
            ...
            return [2 /*return*/, { directiveAck: undefined, provider: provider, model: model }];
          }
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            (0, directive_handling_impl_js_1.handleDirectiveOnly)({
              cfg: cfg,
              directives: directives,
        ...
        case 4:
          ...
          if (
            sessionEntry === null || sessionEntry === void 0 ? void 0 : sessionEntry.modelOverride
          ) {
            model = sessionEntry.modelOverride;
          }
          return [2 /*return*/, { directiveAck: directiveAck, provider: provider, model: model }];
      }
    });
  });
}
